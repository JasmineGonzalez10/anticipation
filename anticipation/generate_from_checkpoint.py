...
instruments = [66, 0, 128, 32, 55026, 55026, 55026, 55026, 55026, 55026, 55026, 55026, 55026, 55026, 55026, 55026]
...
for i in range(5):
    ...
    mid.save(f'/jagupard26/scr1/gonzalez2/model_output/{model_name}/generated-twinkle-818-{i}.mid')
